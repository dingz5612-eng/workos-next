...
export function routeView(ctx) {
  ...
  const views = {
    ...
    businessRecords: () => simpleView("searchOperationCases", "businessRecordsBody", ctx),
    completedRecords: () => simpleView("completedWorkItems", "completedRecordsBody", ctx),
    evidenceLibrary: () => simpleView("searchEvidence", "evidenceLibraryBody", ctx),
