...
2. Workbench must not use local demo queues or static workspace projection
   fixtures.
3. Production offline behavior must show a real cached queue or a true
   empty/error state, never fake business objects.
