...
const out = cli.value("out", "artifacts/oam/checks/shared-governance-boundary-report.json");
const policyPath = "docs/business/shared-governance/subject-vehicle-truth.yml";
const positiveRoot = "tests/fixtures/oam-shared-governance/positive";
const negativeRoot = "tests/fixtures/oam-shared-governance/negative";
