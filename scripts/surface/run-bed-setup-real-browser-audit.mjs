...
const runId = process.env.WORKOS_BED_SETUP_BROWSER_RUN_ID || `bed-setup-layout-${timestamp()}`;
const artifactRoot = path.join(root, "artifacts", "oam", "evidence", "bed-setup-real-browser", runId);
