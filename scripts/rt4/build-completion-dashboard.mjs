...
const nextAllowed = currentGate === "RT-0"
  ...
  : currentGate === "RT-1"
    ...
    : currentGate === "RT-P"
    ? "RT-3 stacked preconstruction"
    : currentGate === "RT-3"
    ? "RT-S stacked preconstruction"
    : currentGate === "RT-S"
    ? "RT-B stacked preconstruction"
    : currentGate === "RT-B"
    ? "RT-4 stacked preconstruction"
    : currentGate === "RT-4"
    ? "RT-5 stacked preconstruction"
    : currentGate === "RT-5"
    ? "RT-6 stacked preconstruction"
    : currentGate === "RT-X"
