...
if (dashboard.repairProduction !== "BLOCKED") violations.push("Repair Production must be BLOCKED.");
if (dashboard.partsProduction !== "BLOCKED") violations.push("Parts Production must be BLOCKED.");
