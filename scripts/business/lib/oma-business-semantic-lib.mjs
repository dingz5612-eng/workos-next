...
export const artifactPath = "artifacts/oma/checks/dormitory-business-semantic-contract-result.json";
...
export function writeCheckResult(checkId, violations, scannedFiles) {
  ...
  let existing = {
    version: "oma.dormitory.business-semantic-contract-result.v1",
    domain: "dormitory",
  ...
  existing.generated_by = "OMA dormitory business semantic contract checkers";
