...
const outputRoot = process.env.WORKOS_DORMITORY_SCENARIO10_OUTPUT_ROOT || root;
const scenarioSourcePath = "docs/business/domains/dormitory/dormitory-scenario10-cancel-noshow-refund.authority.json";
...
const generatorVersion = "oam.dormitory-scenario10-cancel-noshow-refund-generator.v1";
const outputPaths = {
  canonical: "docs/contracts/generated/dormitory/scenario10-cancel-noshow-refund.generated.json",
  objectStateModel: "docs/contracts/generated/dormitory/scenario10-object-state-model.generated.json",
  stepsFields: "docs/contracts/generated/dormitory/scenario10-steps-fields.generated.json",
  crudPolicy: "docs/contracts/generated/dormitory/scenario10-crud-policy.generated.json",
  ...
  testPlan: "docs/contracts/generated/dormitory/scenario10-test-plan.generated.json",
...
const inputDigest = digestObject({
  version: "oam.dormitory-scenario10-input.v1",
  inputDigests
});
const packageIndexRow = (packageIndex.scenarioPackageOrder ?? []).find((item) => item.packageNo === 10);
...
const generated = {
  canonical: {
    ...
    cancellationStatusOptions: scenario.cancellationStatusOptions,
    cancelNoShowInvariantRule: scenario.cancelNoShowInvariantRule,
  ...
  financeGate: {
    ...
    financeTruthRuleZh: "finance-gate 只能读取退款/扣费意向、政策依据、已收/押金摘要、客户确认和证据摘要后处理实际退款、扣费、冲正或账务；业务 runtime 不得直接写 Payment、Refund、LedgerEntry 或 LedgerTransaction。",
    refundFeeIntentOnly: true,
...
console.log("Dormitory scenario 10 cancel no-show refund contracts generated.");
...
function writeGenerated(file, key, content) {
  const base = {
    generated: true,
    doNotEdit: true,
    kind: `dormitory-scenario10-${key}.generated`,
    version: `oam.dormitory-scenario10-${key}.generated.v1`,
    generatorVersion,
    generatedBy,
    generatedFrom,
    inputDigest,
