...
const outputRoot = process.env.WORKOS_DORMITORY_SCENARIO12_OUTPUT_ROOT || root;
const scenarioSourcePath = "docs/business/domains/dormitory/dormitory-scenario12-channel-corporate-customer.authority.json";
...
const generatorVersion = "oam.dormitory-scenario12-channel-corporate-customer-generator.v1";
const outputPaths = {
  canonical: "docs/contracts/generated/dormitory/scenario12-channel-corporate-customer.generated.json",
  objectStateModel: "docs/contracts/generated/dormitory/scenario12-object-state-model.generated.json",
  stepsFields: "docs/contracts/generated/dormitory/scenario12-steps-fields.generated.json",
  crudPolicy: "docs/contracts/generated/dormitory/scenario12-crud-policy.generated.json",
  ...
  testPlan: "docs/contracts/generated/dormitory/scenario12-test-plan.generated.json",
...
const inputDigest = digestObject({
  version: "oam.dormitory-scenario12-input.v1",
  inputDigests
});
const packageIndexRow = (packageIndex.scenarioPackageOrder ?? []).find((item) => item.packageNo === 12);
...
const generated = {
  canonical: {
    ...
    channelCorporateStatusOptions: scenario.channelCorporateStatusOptions,
    channelCorporateInvariantRule: scenario.channelCorporateInvariantRule,
  ...
  financeGate: {
    ...
    financeTruthRuleZh: "finance-gate 或财务规则权威只能读取佣金/结算规则意向、佣金依据、结算说明、合同证据摘要和只读对象引用后处理财务规则；业务 runtime 不得直接写 Payment、Refund、LedgerEntry 或 LedgerTransaction。",
    commissionSettlementIntentOnly: true,
...
console.log("Dormitory scenario 12 channel corporate customer contracts generated.");
...
function writeGenerated(file, key, content) {
  const base = {
    generated: true,
    doNotEdit: true,
    kind: `dormitory-scenario12-${key}.generated`,
    version: `oam.dormitory-scenario12-${key}.generated.v1`,
    generatorVersion,
    generatedBy,
    generatedFrom,
    inputDigest,
