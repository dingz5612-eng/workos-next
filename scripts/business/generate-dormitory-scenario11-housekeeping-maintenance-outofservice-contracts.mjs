...
const outputRoot = process.env.WORKOS_DORMITORY_SCENARIO11_OUTPUT_ROOT || root;
const scenarioSourcePath = "docs/business/domains/dormitory/dormitory-scenario11-housekeeping-maintenance-outofservice.authority.json";
...
const generatorVersion = "oam.dormitory-scenario11-housekeeping-maintenance-outofservice-generator.v1";
const outputPaths = {
  canonical: "docs/contracts/generated/dormitory/scenario11-housekeeping-maintenance-outofservice.generated.json",
  objectStateModel: "docs/contracts/generated/dormitory/scenario11-object-state-model.generated.json",
  stepsFields: "docs/contracts/generated/dormitory/scenario11-steps-fields.generated.json",
  crudPolicy: "docs/contracts/generated/dormitory/scenario11-crud-policy.generated.json",
  ...
  testPlan: "docs/contracts/generated/dormitory/scenario11-test-plan.generated.json",
...
const inputDigest = digestObject({
  version: "oam.dormitory-scenario11-input.v1",
  inputDigests
});
const packageIndexRow = (packageIndex.scenarioPackageOrder ?? []).find((item) => item.packageNo === 11);
...
const generated = {
  canonical: {
    ...
    workStatusOptions: scenario.workStatusOptions,
    housekeepingMaintenanceInvariantRule: scenario.housekeepingMaintenanceInvariantRule,
  ...
  financeGate: {
    ...
    financeTruthRuleZh: "finance-gate 或支出治理只能读取费用意向、费用依据、供应商凭证、作业证据摘要和只读对象引用后处理财务事实；业务 runtime 不得直接写 Payment、Refund、LedgerEntry 或 LedgerTransaction。",
    expenseIntentOnly: true,
...
console.log("Dormitory scenario 11 housekeeping maintenance out-of-service contracts generated.");
...
function writeGenerated(file, key, content) {
  const base = {
    generated: true,
    doNotEdit: true,
    kind: `dormitory-scenario11-${key}.generated`,
    version: `oam.dormitory-scenario11-${key}.generated.v1`,
    generatorVersion,
    generatedBy,
    generatedFrom,
    inputDigest,
