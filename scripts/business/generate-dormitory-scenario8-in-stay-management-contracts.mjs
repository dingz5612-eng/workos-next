...
const outputRoot = process.env.WORKOS_DORMITORY_SCENARIO8_OUTPUT_ROOT || root;
const scenarioSourcePath = "docs/business/domains/dormitory/dormitory-scenario8-in-stay-management.authority.json";
...
const generatorVersion = "oam.dormitory-scenario8-in-stay-management-generator.v1";
const outputPaths = {
  canonical: "docs/contracts/generated/dormitory/scenario8-in-stay-management.generated.json",
  objectStateModel: "docs/contracts/generated/dormitory/scenario8-object-state-model.generated.json",
  stepsFields: "docs/contracts/generated/dormitory/scenario8-steps-fields.generated.json",
  crudPolicy: "docs/contracts/generated/dormitory/scenario8-crud-policy.generated.json",
  ...
  testPlan: "docs/contracts/generated/dormitory/scenario8-test-plan.generated.json",
...
const inputDigest = digestObject({
  version: "oam.dormitory-scenario8-input.v1",
  inputDigests
});
const packageIndexRow = (packageIndex.scenarioPackageOrder ?? []).find((item) => item.packageNo === 8);
...
const generated = {
  canonical: {
    ...
    stayStatusOptions: scenario.stayStatusOptions,
    inStayInvariantRule: scenario.inStayInvariantRule,
...
console.log("Dormitory scenario 8 in-stay management contracts generated.");
...
function writeGenerated(file, key, content) {
  const base = {
    generated: true,
    doNotEdit: true,
    kind: `dormitory-scenario8-${key}.generated`,
    version: `oam.dormitory-scenario8-${key}.generated.v1`,
    generatorVersion,
    generatedBy,
    generatedFrom,
    inputDigest,
