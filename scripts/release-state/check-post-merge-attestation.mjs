...
const expectedPrNumber = Number(process.env.OAM_POST_MERGE_PR_NUMBER || 72);
...
if (attestation.prNumber !== expectedPrNumber) failures.push(`post-merge attestation 必须绑定 PR #${expectedPrNumber}。`);
