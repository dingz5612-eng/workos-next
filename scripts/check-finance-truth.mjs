...
const out = cli.value("out", ".tmp/rt3/finance-truth-report.json");
const positiveRoot = "tests/fixtures/rt3-finance-truth/positive";
const negativeRoot = "tests/fixtures/rt3-finance-truth/negative";
...
function validateContracts() {
  ...
  if (pipeline.goNoGo?.productionAllowed !== false) {
    violations.push(violation("finance_truth.production_claim", "docs/business/finance/finance-truth-pipeline.yml", "RT-3 must not declare production allowed."));
  }
