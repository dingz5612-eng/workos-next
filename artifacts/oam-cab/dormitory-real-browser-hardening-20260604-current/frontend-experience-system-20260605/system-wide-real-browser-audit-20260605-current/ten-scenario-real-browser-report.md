...
- Run ID: system-wide-real-browser-audit-20260605-current
- Status: failed
...
| 处理押金 | passed | failed | 1 |
| 登记普通收款 | passed | failed | 1 |
...
| network.operations_confirm_count | failed |
