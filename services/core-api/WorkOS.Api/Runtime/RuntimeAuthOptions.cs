...
public static class RuntimePasswordHasher
{
    ...
    public static bool Verify(string value, string expectedHash)
    {
        ...
        if (IsSupersededSha256(expectedHash))
        {
    ...
    public static bool IsSupersededSha256(string hash) =>
