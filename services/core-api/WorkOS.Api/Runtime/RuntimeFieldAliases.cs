...
internal static class RuntimeFieldAliases
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> OptionAliases =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["bedType"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ["上下铺"] = "bunk_pair",
                ["上下铺一组"] = "bunk_pair",
                ["上下铺：两上两下"] = "bunk_pair",
            ...
            ["reservationNextAction"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { ["继续转入住"] = "convert", ["转入住"] = "convert", ["取消并释放预留"] = "cancel", ["取消"] = "cancel" },
    ...
    public static string? OptionKeyForField(string canonicalKey) => canonicalKey switch
    {
        ...
        "reservationNextAction" => "reservationNextAction",
