        ...
        bool productionRequested)
    {
        ...
        if (productionRequested)
        {
            return AdmissionKernelDecision.Blocked(
                ...
                new[] { "artifacts/release-state/current-state.json", "docs/business/business-line-registry.json", "docs/contracts/definition/workitem-definition-registry.json" },
                requiredCapabilities,
                requiredDeviceTrust,
                businessLine.Level,
                businessLine.SurfaceMode,
    ...
    string AdmissionDecisionRef)
{
    public static AdmissionKernelDecision AllowedInternalPilot(
        ...
        new(
            ...
            reason,
            new[] { "artifacts/release-state/current-state.json" },
            requiredCapabilities,
            requiredDeviceTrust,
            businessLineState,
