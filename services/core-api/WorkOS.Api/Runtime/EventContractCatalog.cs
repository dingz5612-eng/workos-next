...
internal static class EventContractCatalog
{
    ...
    private static string[] Types(string cardId) => cardId switch
    {
        ...
        "depositRefund" => new[] { "Accommodation.DepositRefundApproved", "Accommodation.DepositRefundPaid" },
        ...
        "depositSettlement" => new[] { "Accommodation.DepositSettledForCheckout" },
        ...
        "roomReleaseAfterService" => new[] { "Accommodation.RoomReleasedAfterService", "Accommodation.BedReleasedAfterService" },
